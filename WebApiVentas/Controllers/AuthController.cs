    ...
    public class AuthController : ControllerBase
    {
        ...
        private static string CreateToken()
        {
            ...
            var claims = new[] {
                        ...
                        new Claim("UserId", "1"),
                        new Claim("DisplayName", "ANGELO FABIAN HINOSTROZA MORALES"),
                        new Claim("UserName", "ANFAHIMO"),
                        new Claim(ClaimTypes.Role, "Administrador"),
                        new Claim("Email", "i2227354@continental.edu.pe")
                    };
